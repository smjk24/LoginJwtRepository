    ...
    public class ApplicationDbContext:DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Account>()
                .HasData(
                new Account() { UserId = 1, UserName = "sanoop", UserPassword = "12345", UserRole = "SuperAdmin" },
                new Account() { UserId = 2, UserName = "kohli", UserPassword = "1234", UserRole = "User" },
                new Account() { UserId = 3, UserName = "Sachin", UserPassword = "123", UserRole = "Admin" }
                );
        }
    }
}
